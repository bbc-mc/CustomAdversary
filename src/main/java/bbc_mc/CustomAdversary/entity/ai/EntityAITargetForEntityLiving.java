...
/**
 動作主体がEntityLivingな EntityAITarget

 @author bbc_mc
 @date 2016/08/03
 */
public abstract class EntityAITargetForEntityLiving  extends EntityAIBase {
    ...
    public EntityAITargetForEntityLiving(EntityLiving taskOwner, boolean checkSight) {
        this(taskOwner, checkSight, false);
    }

    public EntityAITargetForEntityLiving(EntityLiving taskOwner, boolean checkSight, boolean onlyNearby) {
